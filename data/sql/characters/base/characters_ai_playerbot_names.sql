...
LOAD DATA LOCAL INFILE 'F:/Code/Study/azcore-bots/data/sql/characters/base/characters_ai_playerbot_names_chin.csv' INTO TABLE ai_playerbot_names FIELDS TERMINATED BY ';';
